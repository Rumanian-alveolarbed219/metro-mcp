...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/steve228uk/metro-mcp

features:
  - icon: 🔌
    title: Zero setup
    details: Connects to Metro via Chrome DevTools Protocol. No app modifications required for core debugging features.
  - icon: 🧩
    title: Plugin-based
  ...
  - icon: 📊
    title: Profiling
    details: CPU profiling via Hermes CDP and React Profiler integration to find performance hotspots fast.
  - icon: 🛠️
    title: Full control
